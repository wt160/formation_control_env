...
experiment_configurations = [
    {
        "scenario_name": "formation_control_teacher_graph_obs_cuda1_bitmap2_tunnel_to_clutter",
        "experiment_name": "ppo_bitmap_lr3e4_std0.2_rwg1_rwc-0.5",
        "train_env_type": "bitmap",
        "policy_filename": "", # Optional: if you have one
        "critic_filename": "", 
        "output_policy_filename": "ppo_bitmap_tunnel_to_clutter.pth",
        "output_critic_filename": "ppo_bitmap_tunnel_to_clutter_critic.pth",
        "steps_per_epoch": 100,
