...
if __name__ == "__main__":
    ...
    # use_vmas_env(
    #     scenario_name="formation_control_teacher_graph_obs_cuda1_improve",
    #     render=False,
    #     num_envs=1,
    #     n_steps=350,
    #     save_render=False,
    ...
    #     filename="collected_data_door_improve.pkl",
    # )
    ...
    #     env_type="clutter",
    #     working_mode="imitation",
    #     filename="collected_data_clutter_improve.pkl",
    # )
    ...
    #     env_type="tunnel",
    #     working_mode="imitation",
    #     filename="collected_data_tunnel_0_improve.pkl",
    # )
    ...
    use_vmas_env(
        ...
        env_type="narrow",
        working_mode="imitation",
        filename="collected_data_narrow_improve.pkl",
    )
