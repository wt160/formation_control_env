...
if __name__ == "__main__":
    ...
    # use_vmas_env(
    #     scenario_name="formation_control_teacher_graph_obs_cuda1_imitate",
    #     render=False,
    #     num_envs=1,
    #     n_steps=450,
    #     save_render=False,
    ...
    #     filename="collected_data_tunnel_imitate.pkl",
    # )
    ...
    use_vmas_env(
        ...
        env_type="door",
        working_mode="imitation",
        filename="collected_data_door_imitate.pkl",
    )
    ...
    #     env_type="clutter",
    #     working_mode="imitation",
    #     filename="collected_data_clutter_imitate.pkl",
    # )
    ...
    #     env_type="narrow",
    #     working_mode="imitation",
    #     filename="collected_data_narrow_imitate.pkl",
    # )
