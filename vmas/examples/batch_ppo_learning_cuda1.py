...
argument_sets = [
    {"train_env_type": "clutter", "policy_filename": "best_imitation_model_clutter_11.pth", "output_policy_filename": "best_ppo_clutter_3.pth", "steps_per_epoch":"500", "device":"cuda:1"},
    # {"train_env_type": "door_and_narrow", "policy_filename": "best_imitation_model_door_narrow_0.pth", "output_policy_filename": "best_ppo_door_and_narrow_1.pth", "steps_per_epoch":"500", "device":"cuda:1"},
    # {"train_env_type": "tunnel", "policy_filename": "best_imitation_model_tunnel_1.pth", "output_policy_filename": "best_ppo_tunnel_0.pth", "steps_per_epoch":"500", "device":"cuda:1"},
...
for args in argument_sets:
    ...
    subprocess.run(
        ["python", "ppo_train_1.py", env_type, policy_filename, output_policy_filename, steps_per_epoch, device],
