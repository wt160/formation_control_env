...
class VMASWrapper:
    def __init__(self, scenario_name, num_envs, device, continuous_actions, n_agents, env_type=None):
        self.env = make_env(
...
pretrained_weights = torch.load('best_gnn_model_7dim.pth', map_location=device)
