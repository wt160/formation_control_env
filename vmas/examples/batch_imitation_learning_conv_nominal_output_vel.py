...
argument_sets = [
    ...
    {"data_filename": "collected_data_door_conv_nominal_7_real_vel.pkl", "policy_filename": "best_imitation_model_door_conv_nominal_output_vel.pth"},
...
for args in argument_sets:
    ...
    subprocess.run(
        ["python", "gnn_train_graph_obs_add_noise_cuda1_conv_nominal_output_vel.py", data_filename, policy_filename],
