...
argument_sets = [
    ...
    {"train_env_type": "door", "policy_filename": "best_ppo_door_conv.pth", "output_policy_filename": "best_ppo_door_conv_eva.pth", "steps_per_epoch":"300", "device":"cpu", "noise_level":"0.0"},
...
for args in argument_sets:
    ...
    subprocess.run(
        ["python", "ppo_evaluation_conv.py", env_type, policy_filename, output_policy_filename, steps_per_epoch, device, noise_level],
