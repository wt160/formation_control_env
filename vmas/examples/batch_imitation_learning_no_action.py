...
argument_sets = [
    {"data_filename": "collected_data_narrow_0_no_action.pkl", "policy_filename": "best_imitation_model_narrow_noise_0_no_action.pth"},
    ...
    {"data_filename": "collected_data_clutter_0_no_action.pkl", "policy_filename": "best_imitation_model_clutter_0_no_action.pth"},
]
