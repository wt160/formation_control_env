...
argument_sets = [
    ...
    {"data_filename": "collected_data_door_conv.pkl", "policy_filename": "best_imitation_model_door_conv.pth"},
...
for args in argument_sets:
    ...
    subprocess.run(
        ["python", "gnn_train_graph_obs_add_noise_cuda1_conv.py", data_filename, policy_filename],
