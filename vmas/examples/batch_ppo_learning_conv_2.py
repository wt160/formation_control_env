...
argument_sets = [
    ...
    {"train_env_type": "tunnel", "policy_filename": "best_imitation_model_tunnel_conv.pth", "output_policy_filename": "best_ppo_tunnel_conv.pth", "steps_per_epoch":"500", "device":"cpu"},
