...
experiment_configurations = [
    {
        "scenario_name": "formation_control_teacher_graph_obs_cuda1_bitmap2_tunnel",
        "experiment_name": "ppo_bitmap_lr3e4_std0.2_rwg1_rwc-0.5",
        "train_env_type": "bitmap",
        "policy_filename": "ppo_bitmap_tunnel_with_laser.pth", # Optional: if you have one
        "critic_filename": "ppo_bitmap_tunnel_critic_with_laser.pth", 
        "output_policy_filename": "ppo_bitmap_tunnel_with_laser.pth",
        "output_critic_filename": "ppo_bitmap_tunnel_critic_with_laser.pth",
        "steps_per_epoch": 500,
