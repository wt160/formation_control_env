...
argument_sets = [
    ...
    {"train_env_type": "narrow", "policy_filename": "best_imitation_model_narrow_imitate.pth", "output_policy_filename": "1.pth", "steps_per_epoch":"300", "device":"cpu", "noise_level":"0.6"},

    # {"train_env_type": "clutter", "policy_filename": "best_imitation_model_clutter_imitate.pth", "output_policy_filename": "2.pth", "steps_per_epoch":"300", "device":"cpu", "noise_level":"0.0"},

    # {"train_env_type": "door", "policy_filename": "best_imitation_model_door_imitate.pth", "output_policy_filename": "3.pth", "steps_per_epoch":"350", "device":"cpu", "noise_level":"0.0"},
    # {"train_env_type": "tunnel", "policy_filename": "best_imitation_model_tunnel_imitate.pth", "output_policy_filename": "4.pth", "steps_per_epoch":"400", "device":"cpu", "noise_level":"0.0"},
...
for args in argument_sets:
    ...
    subprocess.run(
        ["python", "ppo_evaluation_imitation.py", env_type, policy_filename, output_policy_filename, steps_per_epoch, device, noise_level],
