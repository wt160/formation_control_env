...
def use_vmas_env(
    ...
    pretrained_weights = torch.load('best_imitation_model_narrow_noise_0_no_action.pth', map_location=device)
...
if __name__ == "__main__":
    ...
    use_vmas_env(
        scenario_name="formation_control_teacher_graph_obs_no_action",
        render=True,
        num_envs=1,
        n_steps=300,
        device="cuda:1",
