...
argument_sets = [
    ...
    # {"train_env_type": "narrow", "policy_filename": "best_ppo_narrow_conv.pth", "output_policy_filename": "best_ppo_narrow_conv_eva.pth", "steps_per_epoch":"300", "device":"cpu", "noise_level":"0.0"},
    ...
    # {"train_env_type": "clutter", "policy_filename": "best_ppo_clutter_conv.pth", "output_policy_filename": "best_ppo_clutter_conv_eva.pth", "steps_per_epoch":"300", "device":"cpu", "noise_level":"0.0"},
    ...
    {"train_env_type": "door", "policy_filename": "best_imitation_model_door_conv_nominal_output_vel.pth", "output_policy_filename": "best_ppo_door_conv_eva.pth", "steps_per_epoch":"300", "device":"cpu", "noise_level":"0.0"},
    ...
    # {"train_env_type": "tunnel", "policy_filename": "best_ppo_tunnel_conv.pth", "output_policy_filename": "best_ppo_tunnel_conv_eva.pth", "steps_per_epoch":"400", "device":"cpu", "noise_level":"0.0"},
...
for args in argument_sets:
    ...
    subprocess.run(
        ["python", "ppo_evaluation_imitation_conv_nominal_output_vel.py", env_type, policy_filename, output_policy_filename, steps_per_epoch, device, noise_level],
