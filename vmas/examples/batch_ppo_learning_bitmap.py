...
argument_sets = [
    ...
    # {"train_env_type": "tunnel", "policy_filename": "best_imitation_model_tunnel_1.pth", "output_policy_filename": "best_ppo_tunnel_0.pth", "steps_per_epoch":"500", "device":"cpu"},
     {"train_env_type": "bitmap_tunnel", "policy_filename": "best_ppo_bitmap_tunnel_0_test.pth", "output_policy_filename": "best_ppo_bitmap_tunnel_0.pth", "steps_per_epoch":"500", "device":"cpu"},
