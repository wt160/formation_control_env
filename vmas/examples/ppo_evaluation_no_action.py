...
# log_dir = f'runs/ppo_training_{current_time}_no_action_eva_noise'
log_dir = f'runs/ppo_eva_{current_time}_{train_env_type}_no_action_{str(noise_level)}'
...
for epoch_restart in range(eval_epoch_restart_num):
    ...
    for step in range(steps_per_epoch):
        ...
        obs = next_obs
    save_video("ppo_training_{}_{}_{}_{}_no_action".format(current_time, epoch_restart, train_env_type, noise_level), frame_list, fps=1 / 0.1)
