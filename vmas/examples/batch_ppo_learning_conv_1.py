...
argument_sets = [
    {"train_env_type": "clutter", "policy_filename": "best_imitation_model_clutter_conv.pth", "output_policy_filename": "best_ppo_clutter_conv.pth", "steps_per_epoch":"300", "device":"cpu"},
    ...
    # {"train_env_type": "narrow", "policy_filename": "best_imitation_model_narrow_conv.pth", "output_policy_filename": "best_ppo_narrow_conv.pth", "steps_per_epoch":"300", "device":"cpu"},
    # {"train_env_type": "door", "policy_filename": "best_imitation_model_door_conv.pth", "output_policy_filename": "best_ppo_door_conv.pth", "steps_per_epoch":"300", "device":"cpu"},
...
for args in argument_sets:
    ...
    subprocess.run(
        ["python", "ppo_train_conv.py", env_type, policy_filename, output_policy_filename, steps_per_epoch, device],
