...
argument_sets = [
    ...
    # {"train_env_type": "door_and_narrow", "policy_filename": "best_imitation_model_door_narrow_0.pth", "output_policy_filename": "best_ppo_door_and_narrow_0.pth", "steps_per_epoch":"500", "device":"cuda"},
    # {"train_env_type": "tunnel", "policy_filename": "best_imitation_model_tunnel_1.pth", "output_policy_filename": "best_ppo_tunnel_0.pth", "steps_per_epoch":"500", "device":"cuda"},
