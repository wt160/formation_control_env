...
if __name__ == "__main__":
    ...
    # use_vmas_env(
    #     scenario_name="formation_control_teacher_graph_obs_cuda1_40",
    #     render=False,
    #     num_envs=1,
    #     n_steps=350,
    #     save_render=False,
    ...
    #     filename="collected_data_tunnel_0_40.pkl",
    # )
    use_vmas_env(
        scenario_name="formation_control_teacher_graph_obs_cuda1_40",
        render=False,
        ...
        env_type="narrow",
        working_mode="imitation",
        filename="collected_data_narrow_7_40.pkl",
    )
    ...
    use_vmas_env(
        ...
        env_type="door",
        working_mode="imitation",
        filename="collected_data_door_0_40.pkl",
    )
    ...
    #     env_type="clutter",
    #     working_mode="imitation",
    #     filename="collected_data_clutter_11_40.pkl",
    # )
    ...
    use_vmas_env(
        ...
        working_mode="imitation",
        filename="collected_data_door_narrow_0_40.pkl",
    )
