        ...
        for dim in range(self.batch_dim):
            ...
            for trial in range(max_trials):
                ...
                for _ in range(100):  # Try 100 random points before giving up on this trial
                    if random.random() < 0.5:
                        target_x = random.randint(0, bitmap_width / 2.0)
                    else:
                        target_x = random.randint(bitmap_width / 2.0, bitmap_width - 1)
                    
                    if random.random() < 0.5:
                        target_y = random.randint(0, bitmap_width / 2.0)
                    else:
                        target_y = random.randint(bitmap_width / 2.0, bitmap_width - 1)
